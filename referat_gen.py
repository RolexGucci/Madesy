...
# Aniq model nomlari (alias emas) - zanjir tartibida sinaladi, agar
# birinchisi band (503) bo'lsa keyingisiga o'tiladi. Barchasi
# Flash-Lite - matn/JSON generatsiyasi uchun yetarli va tejamkor.
GEMINI_MODEL_CHAIN = [
...
"""
    ...
    resp = _call_gemini_with_fallback(payload, timeout=120)
