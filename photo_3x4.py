...
def _get_session():
    """rembg sessiyasini "dangasa" (lazy) yuklaydi - `rembg`ni import qilishning
    o'zi sekin (~1 daqiqa), shuning uchun buni bot ishga tushganda emas,
    faqat birinchi haqiqiy so'rov kelganda amalga oshiramiz. Aks holda bot
    web-serverni portga ulanishidan oldin bu import tugashini kutib,
    Render buni "server javob bermayapti" deb noto'g'ri hisoblab qoladi."""
    global _session
    if _session is None:
