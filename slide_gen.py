...
- Qolgan barcha slaydlar "content" turida: title (qisqa), 3-4 ta bullets (har biri 6-12 so'z), va image_keyword
...
def _render_blue(prs, slides):
    ...
    for i, sd in enumerate(slides):
        ...
        if t == "title":
            blk = s.shapes.add_shape(MSO_SHAPE.RECTANGLE, Inches(-2), Inches(4.6), Inches(9), Inches(5))
            blk.rotation = -8
            blk.fill.solid(); blk.fill.fore_color.rgb = BLUE; _set_no_line(blk)
            _add_text(s, Inches(0.9), Inches(2.7), Inches(8), Inches(1.4), sd.get("title", ""), 38, DARK, bold=True)
            _add_text(s, Inches(0.9), Inches(3.75), Inches(8), Inches(0.6), sd.get("subtitle", ""), 18, GRAY)
            _add_text(s, Inches(0.9), Inches(6.3), Inches(6), Inches(0.5), "MADESY", 13, WHITE, bold=True)

        elif t == "divider":
            _bg_fill(prs, s, BLUE)
            _add_text(s, Inches(1), Inches(3.1), Inches(11), Inches(1.2), sd.get("title", ""), 40, WHITE, bold=True)
            _add_text(s, Inches(1), Inches(4.1), Inches(11), Inches(0.6), sd.get("subtitle", ""), 18, RGBColor(0xC9, 0xDD, 0xEA))
...
def _render_dark(prs, slides):
    ...
    for sd in slides:
        ...
        if t == "title":
            ...
            _add_text(s, Inches(0.9), Inches(2.8), Inches(10), Inches(1.5), sd.get("title", ""), 36, WHITE, bold=True)
            _add_text(s, Inches(0.9), Inches(3.85), Inches(9), Inches(0.6), sd.get("subtitle", ""), 18, LIGHT)
            _add_text(s, Inches(0.9), Inches(6.5), Inches(6), Inches(0.5), "MADESY", 13, ACCENT, bold=True)

        elif t == "divider":
            _bg_fill(prs, s, PURPLE)
            _add_text(s, Inches(1), Inches(3.1), Inches(11), Inches(1.2), sd.get("title", ""), 40, WHITE, bold=True)
            _add_text(s, Inches(1), Inches(4.1), Inches(11), Inches(0.6), sd.get("subtitle", ""), 18, LIGHT)
...
def _render_warm(prs, slides):
    ...
    for i, sd in enumerate(slides):
        ...
        if t == "title":
            ...
            _add_text(s, Inches(0.9), Inches(3.0), Inches(9), Inches(1.3), sd.get("title", ""), 34, DARK, bold=True)
            _add_text(s, Inches(0.9), Inches(4.05), Inches(8), Inches(0.6), sd.get("subtitle", ""), 18, GRAY)

        elif t == "divider":
            _bg_fill(prs, s, CORAL)
            _add_text(s, Inches(1), Inches(3.1), Inches(11), Inches(1.2), sd.get("title", ""), 40, CREAM, bold=True)
            _add_text(s, Inches(1), Inches(4.1), Inches(11), Inches(0.6), sd.get("subtitle", ""), 18, RGBColor(0xFF, 0xE8, 0xDF))

        else:
            _bg_fill(prs, s, CREAM)
            badge = s.shapes.add_shape(MSO_SHAPE.ROUNDED_RECTANGLE, Inches(0.9), Inches(0.7), Inches(1.3), Inches(0.5))
            badge.fill.solid(); badge.fill.fore_color.rgb = TEAL if i % 2 else CORAL; _set_no_line(badge)
            _add_text(s, Inches(0.9), Inches(0.82), Inches(1.3), Inches(0.4), f"{i:02d}", 15, CREAM, bold=True, align=PP_ALIGN.CENTER)
...
def _render_yellow(prs, slides):
    ...
    for sd in slides:
        ...
        if t == "title":
            ...
            _add_text(s, Inches(5.2), Inches(2.9), Inches(7.3), Inches(1.4), sd.get("title", ""), 36, WHITE, bold=True)
            _add_text(s, Inches(5.2), Inches(4.0), Inches(7), Inches(0.6), sd.get("subtitle", ""), 18, GRAY_LIGHT)

        elif t == "divider":
            _bg_fill(prs, s, YELLOW)
            _add_text(s, Inches(1), Inches(3.1), Inches(11), Inches(1.2), sd.get("title", ""), 40, BLACK, bold=True)
            _add_text(s, Inches(1), Inches(4.15), Inches(11), Inches(0.6), sd.get("subtitle", ""), 18, RGBColor(0x4A, 0x3A, 0x00))
            ...
            _add_bullets(s, Inches(0.9), Inches(2.9), Inches(7), Inches(4.0), sd.get("bullets", []), 16, BLACK)
...
def build_slide_deck(topic: str, num_slides: int, template: str) -> bytes:
    ...
    _RENDERERS[template](prs, slides_data)
